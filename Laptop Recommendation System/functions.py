...
# This function initiates the variable conversation with the system message.
...
# The following fucntion checks if the user's or the assistant's message is inappropriate. If any of these is inappropriate, you can add a break statement to end the conversation.
